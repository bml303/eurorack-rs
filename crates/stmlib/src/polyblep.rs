//! `stmlib/dsp/polyblep.h` -- polynomial band-limited step, for antialiased
//! discontinuous waveforms (used by the plain oscillator BLEP and the
//! "integrated BLEP" trick for slope/triangle waves).
